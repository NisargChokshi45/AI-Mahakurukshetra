...
- 2 demo orgs
- 2 demo auth users / owner memberships
- 10 suppliers across tiers 1–3
- 5 regions
- 3 active risk events
- 2 open disruptions/incidents
- Multiple alerts, contracts, inventories, shipments, assessments, reports, metrics, integrations, and billing records
